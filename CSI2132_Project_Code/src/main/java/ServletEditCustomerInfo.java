...
public class ServletEditCustomerInfo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		System.out.println("customer edit: "+customerID);
		...
		try {
			run.editCustomer(customerIDint,address, fname, lname, password );
